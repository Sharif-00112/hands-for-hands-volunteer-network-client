    ...
    return (
        <div>
            <div className="position-relative">
                ...
                <div className="content text-center text-white bg-secondary bg-opacity-75 m-3 p-2 position-absolute top-50 start-50 translate-middle">
                    <h1 className='px-7'>HANDS FOR HANDS</h1>
