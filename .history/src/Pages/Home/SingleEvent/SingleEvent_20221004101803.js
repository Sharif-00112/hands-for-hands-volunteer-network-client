...
const SingleEvent = (props) => {
    ...
    const handleInterestedBtn = () =>{
        ...
        if(userEmail){
            axios.post('https://safe-citadel-76278.herokuapp.com/interestedEvents', interestedEventData)
            .then(res => {
                // console.log(res);
    ...
    const handleJoinBtn = () =>{
        ...
        if(userEmail){
            axios.post('https://safe-citadel-76278.herokuapp.com/joinedEvents', joinedEventData)
            .then(res => {
                // console.log(res);
                if(res.data.insertedId){
