            ...
            <div className="col">
                <div className="card h-100">
                    ...
                    <div className="card-footer">
                        <Link to={`/interested/${_id}`}><button className='btn btn-outline-dark btn-sm mx-2'>Interested</button></Link>
                        <Link to={`/join/${_id}`}><button className='btn btn-outline-warning btn-sm mx-2'>Join Now</button></Link>
                    </div>
                </div>
            </div>
        </div>
