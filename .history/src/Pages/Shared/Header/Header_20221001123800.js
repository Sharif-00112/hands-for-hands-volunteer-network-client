                ...
                <Container>
                    ...
                    <Navbar.Collapse className="justify-content-end">
                        ...
                        {user?.email ?
                            ...
                            :
                            <div className="">
                                <Nav.Link as={Link} to="/login" className='mx-3 d-inline'><Button variant='light'>Login</Button></Nav.Link>
                                <Nav.Link as={Link} to="/admin" className='mx-3 d-inline'><Button variant='light'>Admin</Button></Nav.Link>
                            </div>
                        }
                    </Navbar.Collapse>
                </Container>
