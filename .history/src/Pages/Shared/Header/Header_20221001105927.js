            ...
            <Navbar collapseOnSelect expand="lg" bg="secondary" variant="dark" sticky='top'>
                <Container>
                    ...
                    <Navbar.Collapse className="justify-content-end">
                        ...
                        <Nav.Link to="/donation" className='mx-3'>Donation</Nav.Link>
                        <Nav.Link to="/myEvents" className='mx-3'>My Events</Nav.Link>
                        <Nav.Link to="/blog" className='mx-3'>Blog</Nav.Link>
                        {user?.email ?
                            <div className="">
