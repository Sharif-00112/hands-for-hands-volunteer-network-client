                    ...
                    <Navbar.Collapse className="justify-content-end fw-bold">
                        ...
                        {user?.email ?
                            <div className="">
                                ...
                                {/* <Button onClick={logout} className='btn btn-outline-success btn-sm fw-bold'>Logout</Button> */}
                                <Nav.Link as={Link} to="/login" className='mx-1 d-inline'><button className='btn btn-outline-warning btn-sm fw-bold' onClick={logout}>Logout</button></Nav.Link>
